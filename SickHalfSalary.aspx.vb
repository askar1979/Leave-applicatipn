...
Partial Public Class SickHalfSalary
    ...
    Private Sub DetailsViewInsert_ItemInserting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewInsertEventArgs) Handles DetailsViewInsert.ItemInserting
        ...
        Try
            ...
            Try
                ...
                mycommand.CommandType = CommandType.StoredProcedure
                mycommand.CommandText = "[sick_Half_Salary_Decrement]"
                mycommand.Parameters.Clear()
                mycommand.Parameters.AddWithValue("@BatchNumber", TextBoxBatch.Text)
    ...
    Private Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        Try
            ...
            mycommand.CommandText = "select ActualLeaves from LeaveBalance where LeaveTypeID=4 and EmployeeID=" & EmployeeID
            mycommand.CommandType = CommandType.Text
            ActualLeaves = CType(mycommand.ExecuteScalar(), Integer)

            mycommand.CommandText = "select RemainingLeaves from LeaveBalance where LeaveTypeID=4 and EmployeeID=" & EmployeeID
            mycommand.CommandType = CommandType.Text
            ...
            'update LeaveBalance
            mycommand.CommandText = "update LeaveBalance set ActualLeaves=" & ActualLeaves & " where LeaveTypeID=4 and EmployeeID=" & EmployeeID
            mycommand.CommandType = CommandType.Text
            mycommand.ExecuteNonQuery()

            mycommand.CommandText = "update LeaveBalance set RemainingLeaves=" & RemainingLeaves & " where LeaveTypeID=4 and EmployeeID=" & EmployeeID
            mycommand.CommandType = CommandType.Text
            mycommand.ExecuteNonQuery()
